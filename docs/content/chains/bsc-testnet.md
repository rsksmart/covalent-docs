...
All [__Class A__](https://www.covalenthq.com/docs/api/#tag--Class-A) endpoints are supported for BSC Testnet. You can query this blockchain via the unified API by changing the `chainId`.
...
|Token|Ethereum Mainnet|BSC Testnet|
|---|---|---|
